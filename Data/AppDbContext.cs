    ...
    public class AppDbContext : DbContext
    {
        ...
        modelBuilder.Entity<Package>().HasData(
            new Package
            {
                Id = 1,
                Name = "LGS",
                Description = "Lise Giriş Sınavı Matematik Hazırlık Paketi",
                Grade = "8. Sınıf",
                Price = 299.99m,
                VideoCount = 45,
                TestCount = 25,
                DurationMonths = 12,
                Features = "{\"matematik\":true}",
                IsActive = true,
                ColorCode = "#28a745",
            ...
            new Package
            {
                Id = 2,
                Name = "TYT",
                Description = "Temel Yeterlilik Testi Matematik Hazırlık Paketi",
                Grade = "9-10. Sınıf",
                Price = 399.99m,
                VideoCount = 60,
                TestCount = 40,
            ...
            new Package
            {
                Id = 3,
                Name = "AYT",
                Description = "Alan Yeterlilik Testi Matematik Hazırlık Paketi",
                Grade = "12. Sınıf",
                Price = 499.99m,
                VideoCount = 75,
                TestCount = 50,
